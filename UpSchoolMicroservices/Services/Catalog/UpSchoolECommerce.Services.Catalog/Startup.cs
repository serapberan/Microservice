...
namespace UpSchoolECommerce.Services.Catalog
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<DatabaseSettings>(Configuration.GetSection("DatabaseSettings"));//appsetting.json daki tanýmlamalar

            //uygulamay ayaða kalktýðýnda 1 kere oluþtur(singletion) deðeri al
